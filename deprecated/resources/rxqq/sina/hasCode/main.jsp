...
<!--[939,151,1] published at 2011-12-08 17:19:27 from #235 by 90-->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script type="text/javascript">
    ...
    function SUDA(config, ext1, ext2) {
        ...
        var _SP_MPID_ = "";
        var _S_PID_ = "",_S_UNA_ = "SUP",_S_MI_ = "",_S_SID_ = "Apache",_S_GID_ = "SINAGLOBAL",_S_LV_ = "ULV",_S_UO_ = "UOR",_S_UPA_ = "_s_upa",_S_IFW = 320,_S_IFH = 240,_S_GIDT = 0,_S_EXT1 = "",_S_EXT2 = "",_S_SMC = 0,_S_SMM = 10000,_S_ET = 0,_S_ACC_ = "_s_acc";
            ...
            _S_sUOR:function() {
                ...
                if (uoc == "") {
                    if (SA._S_gUCk(_S_LV_) == "" && SA._S_gUCk(_S_LV_) == "") {
                        uor = SA._S_gHost(_S_PREF_);
                        uol = SA._S_gHost(_S_PURL_)
                    }
...
<div class="login">
    ...
    <ul class="server_1">
        <li><a href="javascript:void(0);"
               onclick="_gogame_Ww('webgame036','http://s1.qiuqiu.2010.sina.com.cn/login.aspx');return false;">【新一区】（火爆）&nbsp;&nbsp;&nbsp;&nbsp;</a>
        </li>
    </ul>
    <ul class="server_1">
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);"
                                                   onclick="_gogame_Ww('webgame03602','http://s3.qiuqiu.2010.sina.com.cn/login.aspx');return false;">【新二区】（火爆）
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
    </ul>
...
<div class="news">
    <div class="news_s">
        <ul>
            <li><span class="date">2011-12-08</span><a href="/153/2011/1208/176.html" class="new_title">新浪《热血球球》世界足球日特别活动<img
                    src="http://i2.sinaimg.cn/ty/rexueqiuqiu/images/hot_icon.jpg" width="28" height="11"/></a></li>
            <li><span class="date">2011-12-01</span><a href="/153/2011/1201/175.html"
                                                       class="new_title">新浪《热血球球》周末给力大放送<img
                    src="http://i2.sinaimg.cn/ty/rexueqiuqiu/images/hot_icon.jpg" width="28" height="11"/></a></li>
            <li><span class="date">2011-11-30</span><a href="/153/2011/1130/174.html" class="new_title">新浪《热血球球》12月1日更新维护公告<img
                    src="http://i2.sinaimg.cn/ty/rexueqiuqiu/images/hot_icon.jpg" width="28" height="11"/></a></li>
            <li><span class="date">2011-11-24</span><a href="/153/2011/1124/173.html" class="new_title">新浪《热血球球》百搭返点回馈感恩节激情三重奏<img
                    src="http://i2.sinaimg.cn/ty/rexueqiuqiu/images/hot_icon.jpg" width="28" height="11"/></a></li>
            <li><span class="date">2011-11-17</span><a href="/153/2011/1117/172.html" class="new_title">新浪《热血球球》充值送百搭
                璀璨星光 点亮意志送次级<img src="http://i2.sinaimg.cn/ty/rexueqiuqiu/images/hot_icon.jpg" width="28" height="11"/></a>
            </li>
