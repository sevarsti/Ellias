...
//        System.out.println("hostname:111111111111111111111        " + hostname);
    ...
    public void run() {
        ...
        String URL = "https://bbs.sjtu.edu.cn/";
        System.out.println(URL);
        init();
        List<String> ids = read();
        System.out.println("size: " + ids.size());
        List<String> belowIds = new ArrayList<String>();
        List<String> zeroIds = new ArrayList<String>();
...
//                    HttpURLConnection conn = (HttpURLConnection)url.openConnection();
                    ...
                    tmp = sb.toString();
                    tmp = getInfo(id, tmp);
//                    if(Integer.parseInt(allIds.get(allIds.size() - 1).get("life")) < 0) {
//                        belowIds.add(id);
//                    } else if(Integer.parseInt(allIds.get(allIds.size() - 1).get("life")) == 0) {
//                        zeroIds.add(id);
//                    }
                    log(tmp);
                    error = false;
    ...
    private String getInfo(String id, String in) throws Exception {
        StringBuffer sb = new StringBuffer();
        sb.append(id).append("\t");
