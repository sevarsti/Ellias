...
class TenpayPluginSelectBankActivity$CustomAdapter$2
  implements View.OnClickListener
{
  public void onClick(View paramView)
  {
    ...
    localIntent.putExtra("bank", localBankData.debit.toString());
    TenpayPluginSelectBankActivity.a(TenpayPluginSelectBankActivity.CustomAdapter.a(this.a), "bank." + localBankData.debit.optString("code"));
 ...
 * Qualified Name:     com.tenpay.tenpayplugin.TenpayPluginSelectBankActivity.CustomAdapter.2
