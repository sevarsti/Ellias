...
public class AnimatorInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    while (true)
    {
      ...
      for (localObject = loadObjectAnimator(paramContext, paramAttributeSet); ; localObject = loadAnimator(paramContext, paramAttributeSet, null))
      {
        label76: if (paramAnimatorSet == null)
          break label210;
      ...
      label210: throw new RuntimeException("Unknown animator name: " + paramXmlPullParser.getName());
    }
