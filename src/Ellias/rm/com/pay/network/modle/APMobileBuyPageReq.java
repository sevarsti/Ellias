...
public class APMobileBuyPageReq extends APHttpReqPost
{
  public APMobileBuyPageReq()
  {
    ...
    String str2 = String.format("/v1/r/%s/mobile_buy_page", new Object[] { str1 });
    String str3 = String.format("/v1/r/%s/mobile_buy_page", new Object[] { str1 });
    String str4 = String.format("/v1/r/%s/mobile_buy_page", new Object[] { str1 });
    Object localObject = "";
    try
    {
      ...
      String str5 = String.format("/v1/%s/%s/mobile_buy_page", arrayOfObject);
      localObject = str5;
 ...
 * Qualified Name:     com.pay.network.modle.APMobileBuyPageReq
