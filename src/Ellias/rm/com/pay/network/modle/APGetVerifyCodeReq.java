...
public class APGetVerifyCodeReq extends APHttpReqPost
{
  private String a;

  public APGetVerifyCodeReq()
  {
    String str1 = APAppDataInterface.singleton().getOfferid();
    String str2 = String.format("/v1/r/%s/mobile_get_image", new Object[] { str1 });
    String str3 = String.format("/v1/r/%s/mobile_get_image", new Object[] { str1 });
    String str4 = String.format("/v1/r/%s/mobile_get_image", new Object[] { str1 });
    Object localObject = "";
    try
    {
      ...
      String str5 = String.format("/v1/%s/%s/mobile_get_image", arrayOfObject);
      localObject = str5;
  ...
  public void constructParam()
  {
    ...
    this.httpParam.reqParam.put("type", "bin");
    ...
    this.httpParam.reqParam.put("pay_method", this.a);
 ...
 * Qualified Name:     com.pay.network.modle.APGetVerifyCodeReq
