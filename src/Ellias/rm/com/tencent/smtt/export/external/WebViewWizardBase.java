...
public class WebViewWizardBase
{
  ...
  public boolean setContextHolderParams(Context paramContext, String paramString)
  {
    ...
    {
      arrayOfClass = new Class[] { Context.class, String.class };
    ...
    while (true)
    {
      Object localObject = invokeStaticMethod(this.mIsDynamicMode, "com.tencent.smtt.webkit.ContextHolder", "getInstance", null, new Object[0]);
      if (localObject == null)
        break;
      return ((Boolean)invokeMethod(this.mIsDynamicMode, localObject, "com.tencent.smtt.webkit.ContextHolder", "setContext", arrayOfClass, arrayOfObject)).booleanValue();
      arrayOfClass = new Class[] { Context.class };
