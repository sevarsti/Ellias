...
public class Util
{
  ...
  public static void reportBernoulli(Context paramContext, String paramString1, long paramLong, String paramString2)
  {
    ...
    localBundle.putString("qver", "2.3");
    if (paramLong != 0L)
  ...
  public static final String subString(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: invokestatic 587	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifeq +8 -> 15
    //   10: ldc 245
    //   12: astore_0
    //   13: aload_0
    //   14: areturn
    //   15: aload_2
    //   16: invokestatic 587	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   19: ifne +158 -> 177
    //   22: aload_0
    //   23: aload_2
    //   24: invokevirtual 590	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   27: arraylength
    //   28: iload_1
    //   29: if_icmple -16 -> 13
    //   32: iconst_0
    ...
    //   35: iload 4
    //   37: aload_0
    //   38: invokevirtual 414	java/lang/String:length	()I
    //   41: if_icmpge -28 -> 13
    //   44: aload_0
    //   45: iload 4
    //   47: iload 4
    //   49: iconst_1
    //   50: iadd
    //   51: invokevirtual 408	java/lang/String:substring	(II)Ljava/lang/String;
    //   54: aload_2
    //   55: invokevirtual 590	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   58: arraylength
    //   59: istore 7
    //   61: iload 6
    //   63: iload 7
    ...
    //   71: iconst_0
    //   72: iload 4
    //   74: invokevirtual 408	java/lang/String:substring	(II)Ljava/lang/String;
    //   77: astore 8
    //   79: aload 8
    //   81: astore 9
    //   83: aload_3
    //   84: invokestatic 587	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   87: ifne +28 -> 115
    ...
    //   128: goto -93 -> 35
    //   131: astore 5
    //   133: getstatic 596	java/lang/System:out	Ljava/io/PrintStream;
    ...
    //   149: aload 5
    //   151: invokevirtual 599	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   160: invokevirtual 604	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   163: aload_0
    //   164: areturn
    //   165: astore 10
    //   167: aload 9
