...
public class Tencent
{
  ...
  {
    // Byte code:
    //   0: new 33	android/content/ComponentName
    //   3: dup
    //   4: aload_0
    //   5: invokevirtual 39	android/content/Context:getPackageName	()Ljava/lang/String;
    //   8: ldc 41
    //   10: invokespecial 44	android/content/ComponentName:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   13: astore_2
    //   14: aload_0
    //   15: invokevirtual 48	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   18: aload_2
    //   19: iconst_0
    //   20: invokevirtual 54	android/content/pm/PackageManager:getActivityInfo	(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    //   23: pop
    //   24: new 33	android/content/ComponentName
    //   27: dup
    //   28: aload_0
    //   29: invokevirtual 39	android/content/Context:getPackageName	()Ljava/lang/String;
    //   32: ldc 56
    //   34: invokespecial 44	android/content/ComponentName:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   37: astore 8
    //   39: aload_0
    //   40: invokevirtual 48	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   43: aload 8
    //   45: iconst_0
    //   46: invokevirtual 54	android/content/pm/PackageManager:getActivityInfo	(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    //   49: pop
    //   50: iconst_1
    //   51: ireturn
    //   52: astore_3
    ...
    //   56: dup
    //   57: invokespecial 59	java/lang/StringBuilder:<init>	()V
    //   60: ldc 61
    ...
    //   118: astore 5
    //   120: invokestatic 84	com/tencent/a/a/d:f	()Lcom/tencent/a/a/d;
    //   123: pop
    //   124: ldc 86
    //   126: aload 5
    //   128: invokestatic 89	com/tencent/a/a/d:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   131: iconst_0
    //   132: ireturn
    //   133: astore 9
    ...
    //   152: invokevirtual 70	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: astore 10
    //   157: invokestatic 84	com/tencent/a/a/d:f	()Lcom/tencent/a/a/d;
    //   160: pop
    //   161: ldc 95
    //   163: aload 10
    //   165: invokestatic 89	com/tencent/a/a/d:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   168: iconst_0
    //   169: ireturn
    //
    // Exception table:
  ...
  {
    d.a("openSDK_LOG", "setAccessToken(), expiresIn = " + paramString2 + "");
  ...
  {
    if (this.mAgent == null)
      this.mAgent = new AppbarAgent(paramActivity, this.mQQAuth.getQQToken());
    this.mAgent.startAppbar(paramString);
  }
