...
public class AuthAgent extends BaseApi
{
      ...
      while (true)
      {
        ...
        catch (JSONException localJSONException)
        {
          while (true)
          {
            ...
            d.a("openSDK_LOG", "OpenUi, EncrytokenListener() onComplete error", localJSONException);
            String str1 = null;
          }
  ...
  private Handler e = new Handler()
  {
    ...
    {
      d.b("openSDK_LOG", "OpenUi, handleMessage msg.what = " + paramMessage.what + "");
    ...
    implements IUiListener
  {
    ...
    private void a(String paramString, IUiListener paramIUiListener, Object paramObject)
    {
      ...
      try
      {
        ...
        1 local1 = new ButtonListener(localDialog, paramIUiListener, paramObject)
        {
        ...
        2 local2 = new ButtonListener(localDialog, paramIUiListener, paramObject)
        {
          public void onClick(View paramView)
          {
            if ((this.a != null) && (this.a.isShowing()))
    ...
    implements IRequestListener
  {
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onConnectTimeoutException", paramConnectTimeoutException);
      Message localMessage = new Message();
      localMessage.what = -7;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onHttpStatusException", paramHttpStatusException);
      Message localMessage = new Message();
      localMessage.what = -9;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onIOException", paramIOException);
      Message localMessage = new Message();
      localMessage.what = -2;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onJSONException", paramJSONException);
      Message localMessage = new Message();
      localMessage.what = -4;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onNetworkUnavailableException", paramNetworkUnavailableException);
      Message localMessage = new Message();
      localMessage.what = -2;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onSocketTimeoutException", paramSocketTimeoutException);
      Message localMessage = new Message();
      localMessage.what = -8;
    ...
    {
      d.a("openSDK_LOG", "OpenUi, RequestListener() onUnknowException", paramException);
      Message localMessage = new Message();
      localMessage.what = -6;
    ...
    implements IUiListener
  {
    ...
    public void onComplete(Object paramObject)
    {
      ...
      try
      {
        ...
        catch (Exception localException)
        {
          while (true)
          {
            ...
            d.a("openSDK_LOG", "OpenUi, TokenListener() onComplete error", localException);
          }
        }
      }
      catch (JSONException localJSONException)
      {
        ...
        {
          localJSONException.printStackTrace();
          d.a("openSDK_LOG", "OpenUi, TokenListener() onComplete error", localJSONException);
        }
      }
    }
