    ...
    public DownLoadImp(Context paramWeiyunFileType, FileManager.WeiyunFileType paramWeiyunFile, WeiyunFile paramString, String paramIDownLoadFileCallBack, IDownLoadFileCallBack arg6)
    {
      ...
      this.mHandler = new Handler(this.mContext.getMainLooper(), FileManager.this)
      {
        public void handleMessage(Message paramMessage)
        {
          ...
          {
          default:
            FileManager.DownLoadImp.this.mCallback.onError(new UiError(paramMessage.what, (String)paramMessage.obj, null));
            return;
          case 0:
    ...
    public UploadFileImp(Context paramWeiyunFileType, FileManager.WeiyunFileType paramString, String paramIUploadFileCallBack, IUploadFileCallBack arg5)
    {
      ...
      this.mHandler = new Handler(this.mContext.getMainLooper(), FileManager.this)
      {
        public void handleMessage(Message paramMessage)
        {
          ...
          {
          default:
            FileManager.UploadFileImp.this.mCallback.onError(new UiError(paramMessage.what, (String)paramMessage.obj, null));
            return;
          case 0:
            JSONObject localJSONObject1 = (JSONObject)paramMessage.obj;
            try
