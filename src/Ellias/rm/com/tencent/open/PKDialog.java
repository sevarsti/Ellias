...
public class PKDialog extends h
  implements com.tencent.open.b.a.a
{
    ...
    implements IUiListener
  {
    ...
    public void onComplete(Object paramObject)
    {
      ...
      b.a().a((Context)this.mWeakCtx.get(), this.mAction + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, localJSONObject.optInt("ret", -6), this.mAppid, this.mUrl, "1000067");
      if (this.mWeakL != null)
      {
    ...
    public void onError(UiError paramUiError)
    {
      ...
      {
        b.a().a((Context)this.mWeakCtx.get(), this.mAction + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, paramUiError.errorCode, this.mAppid, str, "1000067");
        if (this.mWeakL != null)
        {
  ...
  private static class THandler extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      do
      {
        ...
        PKDialog.access$800((Context)PKDialog.sWeakContext.get(), (String)paramMessage.obj);
        return;
      }
      while ((PKDialog.sWeakContext == null) || (PKDialog.sWeakContext.get() == null));
      PKDialog.access$900((Context)PKDialog.sWeakContext.get(), (String)paramMessage.obj);
    }
  }
}
