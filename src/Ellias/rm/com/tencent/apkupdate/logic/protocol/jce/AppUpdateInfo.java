...
public final class AppUpdateInfo extends JceStruct
{
  ...
  public final void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    if (a == null)
      a = new PicInfo();
    this.iconUrl = ((PicInfo)paramJceInputStream.read(a, 4, true));
    this.newFeature = paramJceInputStream.readString(5, true);
    if (b == null)
      b = new RatingInfo();
    this.rating = ((RatingInfo)paramJceInputStream.read(b, 6, true));
    ...
    if (c == null)
    {
      ...
      c.add(localApkDownUrl);
    }
    this.apkDownUrl = ((ArrayList)paramJceInputStream.read(c, 19, false));
