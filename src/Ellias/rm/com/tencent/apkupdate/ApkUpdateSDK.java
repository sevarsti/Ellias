...
public class ApkUpdateSDK
{
  ...
  public void checkUpdate(List paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (localIterator.hasNext())
        localArrayList.add(new ApkUpdateParam((String)localIterator.next(), 0, 0));
  ...
  public int patchNewApkByPath(String paramString1, String paramString2, String paramString3)
  {
    ...
    int i = new d().a(paramString1, paramString2, paramString3);
    if ((i == 0) && (localPackageManager.getPackageArchiveInfo(paramString3, 1) == null))
      i = -11;
    return i;
  }
