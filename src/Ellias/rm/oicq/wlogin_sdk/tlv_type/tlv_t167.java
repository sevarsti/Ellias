...
public class tlv_t167 extends tlv_t
{
  ...
  public byte[] get_img_format()
  {
    ...
    System.arraycopy(this._buf, 1 + this._head_len, arrayOfByte, 0, 1);
    return arrayOfByte;
  }
  ...
  public byte[] get_img_url()
  {
    ...
    System.arraycopy(this._buf, 2 + (1 + (1 + this._head_len)), arrayOfByte, 0, this._url_len);
    return arrayOfByte;
  }
  ...
  public Boolean verify()
  {
    ...
    int i = util.buf_to_int16(this._buf, 1 + (1 + this._head_len));
